...
export default function PhaseBandLegend() {
  return <div aria-label="Physiology phase colors" className="flex shrink-0 flex-wrap gap-x-2 gap-y-0.5 text-[8px] text-muted-foreground">
    {[["baseline", "Baseline"], ["build", "Build"], ["plateau", "Plateau"], ["approach", "Climax candidate"], ["recovery", "Release / recovery"]].map(([key, label]) =>

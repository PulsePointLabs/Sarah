...
const TOPIC_GROUPS = Object.freeze([
  ...
  ["physiology / telemetry", /\b(?:heart rate|hrv|rmssd|sdnn|respirat|breath|telemetry|blood pressure|spo2|sp02|oxygen saturation|pulse ox|oximetry|blood glucose|glucose|motion|physiology)\b/i],

...
app.whenReady().then(async () => {
  ...
  win.loadURL(`data:text/html;charset=utf-8,${encodeURIComponent('<body style="margin:0;background:#10161f;color:#f8f4ff;font:16px system-ui;display:grid;place-items:center;height:100vh"><div>Starting Sarah local engine...</div></body>')}`);
